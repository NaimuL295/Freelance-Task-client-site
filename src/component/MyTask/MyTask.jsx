...
useEffect(() => {
  ...
  fetch(`https://assignment-10-server-side-beta-three.vercel.app/tasks?emailParams=${user.email}`)
...
Swal.fire({
  ...
  fetch(`https://assignment-10-server-side-beta-three.vercel.app/tasks/${id}`,{
 method:'DELETE',
 headers: {
